...
def _build_inventory_devices() -> tuple[
    ...
    if snapshot.status == "collector_unavailable":
        ...
        if persisted_snapshot is not None:
            return snapshot, persisted_snapshot.devices, persisted_snapshot.persisted_at
    ...
    return snapshot, inventory_devices, None
...
def build_devices_list_response() -> DevicesListResponse:
    ...
    snapshot, inventory_devices, persisted_at = _build_inventory_devices()
    items = [
        DeviceRecord(

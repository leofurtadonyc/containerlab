...
- **Week 26 Wednesday task 01 (cross-domain evidence pack sections):** numbered cross-domain sections + **`buildSituationEvidenceGapNotes`** (bounded gap callouts from pack fields only)—**no** forensic/workflow chronology claims; **`vitest`**; **`conditionally_ready_with_explicit_limits`** unchanged

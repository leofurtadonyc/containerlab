...
| [**Service evidence timeline**](./service-evidence-timeline-contract.md) (planned **`service_evidence_timeline_v1`**) | **Chronology-first** service scope | **Not** the dossier’s **composed sections**—**time-ordered** evidence; **same** **`service_id`**; **pivot** from dossier to timeline for **when**, dossier for **what** in one screen. |

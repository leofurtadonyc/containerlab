...
| **Priority navigation (cockpit)** | Same **`topology/risk-summary`** top row + worst **`degraded_policy_v1`** row as the attention panels (stable sort) | One-click **topology dossier**, **investigation**, and **policy dossier** pivots labeled as navigation suggestions | Same non-claims as **“Urgent” pivots** — **not** incident priority or approval to change the network. |
